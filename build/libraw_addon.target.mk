...
OBJS := \
	...
	$(obj).target/$(TARGET)/src/libraw_wrapper.o
...
$(builddir)/raw_addon.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/raw_addon.node: TOOLSET := $(TOOLSET)
$(builddir)/raw_addon.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/raw_addon.node
# Add target alias
.PHONY: libraw_addon
libraw_addon: $(builddir)/raw_addon.node

# Short alias for building this executable.
.PHONY: raw_addon.node
raw_addon.node: $(builddir)/raw_addon.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/raw_addon.node
